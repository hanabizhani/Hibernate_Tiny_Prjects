...
public class FilmController {
    ...
    @GetMapping(value = "/getCountFilmsAfterReleaseDate/{releaseDate}")
    public ResponseEntity<Integer> getCountFilmsAfterReleaseDate(
            @PathVariable(name = "releaseDate") int releaseDate){
        return new ResponseEntity<Integer>(
                filmService.getCountFilmsAfterReleaseDate(releaseDate), HttpStatus.OK);
    }
