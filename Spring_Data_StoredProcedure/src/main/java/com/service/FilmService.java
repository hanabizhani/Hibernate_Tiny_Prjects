...
public class FilmService {
    ...
    public int getCountFilmsAfterReleaseDate(int releaseDate){
        Integer result = iFilmRepository.getCountFilmsAfterReleaseDate(releaseDate);
        //int filmCount = (int) result.get("pOutParam");
        return result;
    }
